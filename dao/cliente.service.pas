...
begin
  ...
  begin
    ...
    FCliente.Des_RazaoSocial := FieldByName('DES_RAZAOSOCIAL').AsString;
    FCliente.Des_NomeFantasia := FieldByName('DES_NOMEFANTASIA').AsString;
    ...
    FCliente.Des_CNPJ := FieldByName('DES_CNPJ').AsString;
    FCliente.Des_Telefone := FieldByName('DES_TELEFONE').AsString;
  end;
end;

function TClienteService.BuscarClientePorCodigo(ACodigo: Integer): TCliente;
begin
