...
uses
  ...
  ipedido.repository, pedido.service, ipedido.service, pedidoitens.controller, cliente.repository, umostrapedido,
...
begin
  ...
  begin
    ...
    begin
      ...
      FClienteController.PreencherCamposForm(FCliente, StrToInt(EdtCodCliente.Text));
      with FCliente do
      begin
        FrmMostraPedido.LblNomeCliente.Caption := Des_RazaoSocial;
        FrmMostraPedido.LblEndCompleto.Caption := Des_Endereco;
      ...
      ItensPedido := FPedidoItensController.CarregarItensPedido(FPedido.Cod_Pedido);
      try
        for Item in ItensPedido do
        begin
