...
begin
  ...
  SingleField := TSingleField.Create(TblProdutos);
  SingleField.FieldName := 'VAL_PRECO';
  SingleField.DataSet := TblProdutos;
  SingleField.Name := 'TblProdutosVAL_PRECO';
...
begin
  ...
  begin
    ...
    FProduto.Des_Marca := FieldByName('DES_MARCA').AsString;
